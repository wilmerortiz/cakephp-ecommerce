<?= $this->Form->create($billingAddres, ['class' => 'Formulario', 'id'=>'formBilling', 'novalidate']) ?>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Registrar dirección de facturación</h5>
...
<script>
    ...
    $('#formBilling').submit(function(evt) {
        ...
        if(vForm[0].checkValidity() === false){
            ...
            evt.preventDefault();
            addAndUpdateData(-1, 'modalForm', 'formBilling', 'BillingAddress/add')
        }
