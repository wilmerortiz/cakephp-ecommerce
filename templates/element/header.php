            ...
            <div class="header-right">
                ...
                <div class="dropdown cart-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-cart-products" id="section-cart">
                        ...
                        <div class="dropdown-cart-action">
                            <a href="<?= $this->Url->build(['controller'=>'Cart', 'action'=>'index']) ?>" class="btn btn-primary">View Cart</a>
                            <a href="<?= $this->Url->build(['controller'=>'Checkout', 'action'=>'index']) ?>" class="btn btn-outline-primary-2"><span>Checkout</span><i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .dropdown-cart-total -->
